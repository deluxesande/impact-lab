...
// Swapped from lucide-react to keep one icon set (docs/frontend-discovery.md §3.6).
// Re-running `shadcn add @animate-ui/components-radix-sheet` will revert this.
import { X as XIcon } from 'reicon-react';
